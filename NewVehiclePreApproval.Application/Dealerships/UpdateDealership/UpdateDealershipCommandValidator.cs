...
internal class UpdateDealershipCommandValidator : AbstractValidator<UpdateDealershipCommand>
{
    private const string RequiredErrorMessage = "El campo '{PropertyName}' es obligatorio";

    public UpdateDealershipCommandValidator()
    {
        RuleFor(x => x.Id)
            .NotEmpty().WithMessage(RequiredErrorMessage)
            .WithName("ID de la Concesionaria");
